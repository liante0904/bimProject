...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/bootstrap/css/sidebar.css">
<script src="${pageContext.request.contextPath}/resources/bootstrap/js/sidebar.js"></script>
